    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return  httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/usuario/{id}").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/perfil").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/perfis").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/disciplinas").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/curso").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/cursos").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/curso/{id}").permitAll()
